	...
	return (
		<DayPicker
			...
			classNames={{
				...
				caption_label: 'text-sm mb-3  font-medium',
				nav: 'space-x-1 flex justify-between w-full ',
				nav_button_previous: cn(
					// buttonVariants({ variant: 'outline' }),
					// 'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute mr-auto top-5',
					disableLeftNavigation() && 'pointer-events-none'
				),
				nav_button_next: cn(
					// buttonVariants({ variant: 'default' }),
					// 'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute ml-auto top-5',
